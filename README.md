...
The Microservice was developed for me, guided by [Youtube Channel](https://youtu.be/a3tPHH8uwPc?si=vFf-S2H5i3IpVTjN), to demonstrate how to solve the [AnotaAi Backend Challenge](https://github.com/githubanotaai/new-test-backend-nodejs).
...
aws.secretKey=test
aws.sns.topic.catalog.arn=arn:aws:sns:us-east-1:000000000000:my-topic
```
...
2. Compact index.mjs file into mylambda.zip 
...
2. The API will be accessible at http://localhost:7851
